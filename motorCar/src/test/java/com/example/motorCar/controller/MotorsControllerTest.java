...
class MotorsControllerTest {
    ...
    void testGetAllCars() throws Exception {
        ...
        final List<Motors> motors = List.of(
                new Motors(0, "carName", 0.0, "brand", "color", 0, "avaiabilityDate", false));
    ...
    @Test
    void testGetAllDate() throws Exception {
        // Setup
        // Configure MotorsService.getAllDate(...).
        final List<Motors> motors = List.of(
                new Motors(0, "carName", 0.0, "brand", "color", 0, "avaiabilityDate", false));
        when(mockMotorsService.getAllDate()).thenReturn(motors);

        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(get("/sharathcars/cars/date")
                        .accept(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();
    ...
    @Test
    void testGetAllDate_MotorsServiceReturnsNoItems() throws Exception {
        // Setup
        when(mockMotorsService.getAllDate()).thenReturn(Collections.emptyList());
